...
public class SingleVarDeclarationVarDecl extends VarDecl {

    private Type Type;
    private SingleVarDecl SingleVarDecl;

    public SingleVarDeclarationVarDecl (Type Type, SingleVarDecl SingleVarDecl) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleVarDeclarationVarDecl(\n");
